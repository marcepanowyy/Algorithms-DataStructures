...
# nie przekracza danej liczby W oraz ktorych laczna wysokosc nie przekracza danej
...
# f(i, W, H) = max(f(i-1, W, H), f(i-1, W-i.weight, H-i.height))  if W-i.weight >= 0 and H-i.height >= 0
# bierzemy przedmiot albo nie bierzemy es
# f(0, W, H) =  0 <=> i.weight < w or h.height < h  else T[0].value
